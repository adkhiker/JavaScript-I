...
let lastCar = 0;
console.log("Make of last car in inventory:", inventory[inventory.length - 1]["car_make"]);
console.log("Model of last car in inventory:", inventory[inventory.length - 1]["car_model"]);
